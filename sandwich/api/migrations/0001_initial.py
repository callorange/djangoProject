# Generated by Django 3.2.13 on 2022-04-22 16:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='등록일', verbose_name='등록일')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='수정일', verbose_name='수정일')),
                ('bread', models.ManyToManyField(to='api.Bread', verbose_name='재료')),
                ('cheese', models.ManyToManyField(to='api.Cheese', verbose_name='재료')),
                ('sauce', models.ManyToManyField(to='api.Sauce', verbose_name='재료')),
                ('topping', models.ManyToManyField(to='api.Topping', verbose_name='재료')),
            ],
            options={
                'verbose_name': '샌드위치',
